	...
	<c:choose>
		<c:when test="${ overlap }" >
			...
			<div class="memberInputText">
				입력하신 ${ userId }는 이미 사용 중인 아이디 입니다.
			</div>
			...
			<form action="overlapIdCheck.mvc" name="idCheckForm" 
				...
				<div class="memberInputText">
					...
					<input type="text" name="userId" id="checkId" size="15"/>
		...
		<c:otherwise>
			<h3>사용할 수 있는 아이디</h3>
			<div class="memberInputText">
				입력하신 ${ userId }는 사용할 수 있는 아이디 입니다.</div>
			<div class="memberInputText">
				<input type="button" value="${ userId }을(를) 아이디로 사용하기" 
					id="btnIdCheckClose" data-id-value="${ userId }"/>
			</div>
		</c:otherwise>		
	</c:choose>
	</div>
